...
const Categories = () => {
  return (
    <div className='lg:ml-[12%] fixed top-16 pb-4 sm:ml-12'>
      <div className=' w-[90%] bg-white ml-12 h-100'>
        {/*TOP LINE*/}
        ...
        <div className='display: flex justify-start ml-10 w-[89.5%]'>
          <div className='w-[100%] h-14 display: flex scrollbar-thin overflow-x-auto'>
            <div className='w-[100%] display: flex'>
              {/* ALL DIV*/}
              <div className='w-11 p-4 h-8 bg-black text-white border border-zinc-300 rounded-lg display: flex justify-center items-center my-3 ml-3'>
                <h1 className='text-md'>All</h1>
              </div>
              {/* GAMING DIV*/}
              <div className='w-fit p-4 h-8 border bg-gray-100 border-zinc-300 rounded-full display: flex justify-center items-center my-3 ml-3'>
